...
def Sexualgender (_miss,_mister,_others):
    _userinput= int (input("veuillez introduire 1 si vous êtes une femme" + str (_miss) + "2 si vous êtes un homme" + str (_mister) + "et 3 pour autres genres" + str (_others)  + "\n"))
    if _userinput==miss:
        print("bonjour Madame")
    elif _userinput==mister:
        print("bonjour Monsieur")
    elif _userinput==others:
        print("bonjour à vous")
    else:
        print("le chiffre introduit est incorrect")

miss=1
mister=2
others=3

Sexualgender(miss,mister,others)
