...
def CalculateAgeSum(_age1,_age2):
    print("La première personne a " + str(_age1) + "ans.\nLa deuxième peronne a quant a elle " + str(_age2) + "ans.")
    return str(_age1+_age2)

print("La somme de vos ages vaut : " + CalculateAgeSum(17,32))
